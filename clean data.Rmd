...
##
df <- df[, !(names(df) %in%select(-nmajor, -`Business Direct Admit`, -`First Generation College Stdnt`, 
         -`Combined Bacc and Masters`, -`Dean's List`, -`FSB Scholars`, 
         -`Honors Program`, -`President's List`, -`Cum Laude`, -`Magna Cum Laude`, 
         -`Summa Cum Laude`, -`University Honors`, -`UniversityHonors w/Distinction`, 
         -year.x, -latin_honors, -survey_gradprogram, -survey_gradschool, 
         -survey_internfour, -survey_internone, -survey_internships, 
         -survey_internthree, -survey_interntwo)
## Check for changes
head(df)
