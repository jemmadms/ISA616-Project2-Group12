...
##### An extra index "X" is removed {.unnumbered}
...
We ran the code R.Version（）to determine the version of r studio used to ensure our code can be reproduced. We have also saved our original file "FSB_Survey_Dirty.csv". Thus, we can rerun the code in the future to ensure reproducibility.
